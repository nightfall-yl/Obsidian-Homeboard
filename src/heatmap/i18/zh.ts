...
export class Zh implements Local {
    ...
    context_menu_insert_navbar = "新建导航栏";
    elements_menu_title = "新增 Elements 组件";
	...
	settings_cursor_enable = "启用";
	settings_cursor_enableDesc = "记住每个文件的光标位置和滚动状态";
	...
	navbar_command_new = "新建导航栏";
	heatmap_command_new = "新建热力图";
	 ...
	 * dashboard
	 */
	dashboard_display_name = "Elements 控制台";
	dashboard_banner_subtitle = "你的个人命令中心";
	dashboard_refresh = "刷新";
	dashboard_heatmaps_section = "热力图";
	dashboard_heatmaps_empty = "仓库中未找到热力图";
	dashboard_navbars_section = "导航栏";
	dashboard_navbars_empty = "仓库中未找到导航栏";
	dashboard_calendar_open = "打开日历";
	dashboard_new_heatmap = "新建热力图";
	dashboard_new_navbar = "新建导航栏";
	dashboard_loading = "加载中...";
	dashboard_recent_updates = "最近更新";
	dashboard_col_file = "文件";
	dashboard_col_modified = "修改时间";
	dashboard_col_folder = "位置";
	dashboard_no_recent_files = "暂无最近更新文件";
	dashboard_quick_actions = "快捷操作";
	dashboard_calendar_section = "日历";
	dashboard_open_settings = "设置";
	dashboard_add_module = "添加模块";
	dashboard_add_module_placeholder = "搜索要添加的模块...";
	dashboard_remove_module = "移除模块";
	dashboard_no_modules = "暂无模块，点击上方添加";
	dashboard_module_settings = "模块设置";
	navbar_source_type = "来源类型";
	navbar_source_first = "自动扫描（使用第一个找到的）";
	navbar_source_specific_file = "指定文件";
	navbar_source_file = "指定文件路径";
	navbar_source_file_placeholder = "例如: 文件夹/文件名";
}
