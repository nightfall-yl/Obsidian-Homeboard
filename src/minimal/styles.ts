...
export function updateStyle(settings: MinimalSettings): void {
  removeStyle();
  removeSettings();
  ...
  style.setProperty("--font-ui-small", `${settings.textSmall}px`);
  style.setProperty("--line-height", `${settings.lineHeight}`);
  style.setProperty("--line-width", `${settings.lineWidth}rem`);
  style.setProperty("--line-width-wide", `${settings.lineWidthWide}rem`);
  style.setProperty("--max-width", `${settings.maxWidth}%`);
}
...
export function removeDarkScheme(): void {
  document.body.removeClass(
    "minimal-atom-dark",
    "minimal-ayu-dark",
...
export function removeLightScheme(): void {
  document.body.removeClass(
    "minimal-atom-light",
    "minimal-ayu-light",
