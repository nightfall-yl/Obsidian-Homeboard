...
export function getGraphOptions(): SelectOption<string>[] {
	return [
		{
...
export function getStartOfWeekOptions(): SelectOption<string>[] {
	return [
		{
...
export function getCellShapes(): SelectOption<string>[] {
	return [
		{
...
export function getDataSourceTypes(): SelectOption<DataSourceType>[] {
	return [
		{
...
export function getTaskStatusOptions(): SelectOption<TaskStatus>[] {
	return [
		{
...
export function getDateTypeOptions(): SelectOption<DateRangeType>[] {
	return [
		{
